...
class ClawPart(val claw: Claw, private val flip: Boolean, private val isUpper: Boolean, private val partScale: Float, layer: Int) : EnemyPart("boss3claw${if (isUpper) "upper" else "lower"}") {
    ...
    override val collider = Collider(getRectangleCollisionShape(scaleX = 0.5f), claw)
