...
import com.cozmicgames.bosses.boss1.*
import com.littlekt.math.geom.degrees
import com.littlekt.math.geom.shortDistanceTo
import com.littlekt.util.seconds
import kotlin.time.Duration

class Boss2MovementController(val boss: Boss2): BossMovementController {
    companion object {
        private const val MOVEMENT_SPEED = 0.5f
        private const val ROTATION_SPEED = 3.0f
    }

    var bodyMovement: BodyMovement = WaveBodyMovement(3.0.degrees, 0.8f, 0.2f)
